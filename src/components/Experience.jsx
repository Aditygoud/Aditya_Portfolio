  ...
  const experiences = [
    {
      ...
      description: "Architecting enterprise-grade AI automation ecosystems, including a full-stack HRMPR system, custom OCR pipelines for document digitization, and real-time Computer Vision models for biometric attendance tracking.",
      link: "#" 
    },
    {
      ...
      description: "Analyzed business datasets and created interactive Power BI dashboards to deliver data-driven insights and improving reporting efficiency.",
      link: "#"
    }
  ];
