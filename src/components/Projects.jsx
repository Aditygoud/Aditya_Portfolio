  ...
  const projectData = [
    {
      ...
      title: "HR Manpower Requisition (HRMPR) System",
      category: "AI / Automation",
      description: "An enterprise-grade automation ecosystem developed to digitize and accelerate the hiring workflow. It features a smart OCR pipeline that extracts candidate information from resumes and ID proofs with high precision, significantly reducing manual data entry for the HR department.",
      tech: ["React.js", "FastAPI", "Python", "OCR", "MongoDB", "Machine Learning"],
      keyFeatures: [
        "End-to-end approval workflow automation",
        "Automated data digitization from resumes and IDs",
        "Real-time tracking for manpower requests"
      ]
    },
    {
      id: 2,
      ...
      description: "A high-precision biometric monitoring solution designed to automate workforce management. Utilizing state-of-the-art object detection and facial recognition, this system eliminates manual logging errors and provides real-time attendance tracking for large-scale operations.",
      tech: ["Python", "YOLOv8", "OpenCV", "DeepFace", "TensorFlow", "FastAPI"],
      keyFeatures: [
        "Real-time multi-face recognition and spoof detection",
    ...
    }, 
    {
      ...
      description: "A high-concurrency messaging ecosystem built to handle bi-directional data flow with sub-100ms latency. The system implements a robust event-driven architecture, ensuring that message states (sent, delivered, typing) are synchronized instantly across all active clients without page refreshes.",
      tech: ["React.js", "Socket.io", "Node.js", "Express.js", "MongoDB", "Tailwind CSS"],
      keyFeatures: [
        "Bi-directional communication via WebSocket protocol",
        "Persistent chat history with optimized MongoDB indexing",
        "Real-time 'User is Typing' and Online Status indicators",
        "JWT-based secure authentication and private room logic"
      ]
    },
    {
      id: 4,
      ...
      description: "An advanced predictive analytics system that leverages user metadata and behavioral patterns to generate high-accuracy product suggestions. By implementing matrix factorization and collaborative filtering algorithms, the engine identifies latent features in consumer habits to drive conversion rates and personalized shopping experiences.",
      tech: ["Python", "Scikit-learn", "Collaborative Filtering", "Pandas", "NumPy"],
      keyFeatures: [
        "User-Item interaction matrix for personalized discovery",
        "Cold-start problem mitigation for new users",
        "Scalable data processing pipeline for large datasets",
        "A/B testable recommendation logic for sales optimization"
      ] 
    },
    {
      id: 5,
      title: "Gestural Linguistics Interpreter",
      category: "Computer Vision / Deep Learning",
      description: "A real-time accessibility solution that bridges the communication gap for the hearing-impaired. The system uses a sophisticated spatial-temporal model to extract hand landmarks and classify complex gestures into meaningful text, achieving high precision even in variable lighting conditions.",
      tech: ["Python", "OpenCV", "MediaPipe", "TensorFlow", "LSTM / RNN"],
      keyFeatures: [
        "Real-time 21-point hand landmark tracking",
        "Temporal sequence processing for dynamic gestures",
        "Low-latency inference for seamless translation",
        "Custom-trained deep learning architecture for high accuracy"
      ]
    }
  ];
